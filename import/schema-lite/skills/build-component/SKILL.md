...
compatibility: Requires design.md, tokens.md, components.json, component-library.md, content-system.md, and brands.md to already exist in the project. This skill does not create the schema itself — see the portable core export for that.
loadOrder: design.md → SCHEMA.md → tokens.md → components.json → this file
codedAssets: See SCHEMA.md (Worked Examples section) for component artifact patterns and token usage. Never read css/tokens.css as a source of truth — read tokens.md instead.
---
